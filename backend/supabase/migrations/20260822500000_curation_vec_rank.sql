...
--
-- 화면에 실린 것만 쓴다(보통 9장, 성별 쿼터를 쓰는 ringer는 12장). 큐레이션 조건에
-- 맞는 상품은 수천 건이지만 그것을 다 평균내려면 매번 조건을 다시 컴파일해야 한다.
...
with groups(key, goods) as (values
  ...
  ('ringer', array[6723164,6489139,6262851,6180797,6140524,5254991,5105020,5071723,5039557,6321982,6306558,6193784]::bigint[]),
