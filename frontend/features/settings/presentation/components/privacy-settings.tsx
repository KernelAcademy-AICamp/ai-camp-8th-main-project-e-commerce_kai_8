    ...
    <div>
      ...
      <details className="group">
        ...
        <section className="mt-3 space-y-4 text-[15px] leading-relaxed">
          ...
          <p>
            아래 버튼을 누르면{" "}
            <b className="text-ink">이 기기가 처음 온 사람과 같은 상태</b>로 돌아갑니다
            — 익명 ID·취향 프로필·최근 본 제품·보여줄 상품의 성별이 지워지고, 서버에
            기록된 행동 기록·검색 기록도 삭제됩니다.{" "}
            <b className="text-ink">계정과 계정에 담긴 찜·폴더는 남습니다</b> — 찜과
            폴더는 이 기기가 아니라 계정에 있어서, 다른 기기에서도 그대로 보입니다.
            그것까지 지우려면 로그인한 상태에서 계정 삭제를 쓰세요.
          </p>
