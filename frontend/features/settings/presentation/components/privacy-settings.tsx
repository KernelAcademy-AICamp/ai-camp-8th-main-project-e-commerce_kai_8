      ...
      <details className="group">
        ...
        <section className="mt-3 space-y-4 text-[15px] leading-relaxed">
          ...
          <p>
            ...
            기본 범위인 <b className="text-white">이메일 주소와 구글이 발급한 식별자</b>
            만 받아 계정으로 저장하고, <b className="text-white">찜한 상품 번호</b>를
            계정에 담아 다른 기기에서도 보이게 합니다. 구글에서{" "}
            <b className="text-white">프로필 사진·연락처·성별·생년월일</b>을 받아오지는
            않습니다. 서버에는 계정과 익명 ID를 잇는 기록을 만들지 않습니다 — 다만 이
            기기에는 둘이 함께 남으므로, 기기를 들여다보면 이을 수 있습니다.
          </p>
          <p>
            <b className="text-white">보여줄 상품의 성별</b>은 위에서 직접 고른
            값입니다. 구글에서 받아온 것이 아니라 이 앱에만 있는 설정이고, 로그인하면
            다른 기기에서도 같게 보이도록 계정에 함께 저장합니다.{" "}
            <b className="text-white">아래 초기화로는 지워지지 않습니다</b> — 취향이
            아니라 설정이라서, 지우면 앱을 열 때마다 다시 물어야 하기 때문입니다.
            로그아웃하면 이 기기에서 지워지고, 계정을 삭제하면 계정에 있던 값도 함께
            사라집니다.
          </p>
          <p>
