...
export function AccountDeleteSection({ notice }: { notice: AuthNotice | null }) {
  ...
  return (
    <section className="mt-10 border-t border-neutral-900 pt-6">
      <h2 className="mb-3 text-base font-semibold text-white">계정 삭제</h2>
      ...
      {state.kind === "signedIn" && deletion.status.kind !== "confirming" && (
        <div className="space-y-2">
          ...
          <button
            ...
            className="w-full cursor-pointer rounded-xl border border-red-900/60 py-3 font-medium text-red-400 disabled:opacity-60"
          >
