...
export default function PrivacyPolicyPage() {
  return (
    <main className="mx-auto max-w-md px-4 pb-6 text-ink">
      ...
      <p className="mb-8 text-sm text-ink-soft">최종 갱신 {UPDATED_AT}</p>
      ...
      <section className="mt-8 space-y-4 text-[15px] leading-relaxed">
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            <b className="text-ink">취향 프로필도 만들지 않습니다.</b> 로그인해야
            쌓입니다.
          </li>
        </ul>
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            <b className="text-ink">보여줄 상품의 성별</b>은 설정에서 직접 고른 값으로,
            구글에서 받아온 것이 아닙니다. 다른 기기에서도 같게 보이도록 계정에
            저장하며, 보관 기간은 계정과 같습니다. 개인화 데이터 초기화로 이 기기에서
            지워지고(처음 온 사람과 같은 상태로 돌아갑니다), 로그아웃할 때도 지워지며,
            계정을 삭제하면 계정에 있던 값도 함께 사라집니다.
          </li>
          <li>
          ...
          <li>
            <b className="text-ink">탐색 행동</b> — 카드가 화면에 보임, 상세 열기, 찜,
      ...
      <section className="mt-8 space-y-4 text-[15px] leading-relaxed">
        <h2 className="text-base font-semibold text-ink">얼마나 보관하나요</h2>
        <ul className="list-disc space-y-2 pl-5">
      ...
      <section className="mt-8 space-y-4 text-[15px] leading-relaxed">
        ...
        <p className="text-sm text-ink-soft">
          <b className="text-ink-soft">지워지지 않는 것:</b> 인증 서비스 제공자가 운영
          목적으로 남기는 접속 기록입니다. 우리는 그 기록을 보관하지 않으며, 조회하거나
          삭제할 수도 없습니다. 보존 기간은 확인하지 못했고, 확인되면 이 문서를
          갱신합니다.
        </p>
      </section>

      <section className="mt-8 space-y-4 text-[15px] leading-relaxed">
        <h2 className="text-base font-semibold text-ink">알아두실 것</h2>
        <p>
          검색창에는 무엇이든 입력할 수 있고 입력한 내용이 그대로 기록되므로, 개인적인
          내용은 적지 않는 편이 좋습니다.
        </p>
        <p>
          aTee는 현재 <b className="text-ink">검증 단계</b>의 서비스입니다. 수집 범위가
          바뀌면 이 문서를 갱신하고 앱에서 다시 안내합니다.
        </p>
      </section>
